      ...
      <div className="container mx-auto px-4 py-8 max-w-5xl">
        ...
        <div className="space-y-6">
          ...
          <div className="glass-card">
            <h2 className="text-2xl font-bold text-r7-blue dark:text-r7-neon mb-4">
              🎯 What is This App?
            </h2>
          ...
          <div className="glass-card">
            ...
            <div className="space-y-4">
              <div>
                <h3 className="text-lg font-semibold text-gray-800 dark:text-gray-200 mb-2">1. Import Your Contacts</h3>
                <p className="text-gray-700 dark:text-gray-300">
                  Click <span className="font-semibold text-r7-blue dark:text-r7-neon">"Import CSV"</span> on the dashboard to upload your contact list.
                  Make sure your CSV has columns for: Company Name, Phone, Website, Industry, and Company Size.
                </p>
              </div>

              <div>
                <h3 className="text-lg font-semibold text-gray-800 dark:text-gray-200 mb-2">2. Start Calling</h3>
                <p className="text-gray-700 dark:text-gray-300">
                  Click <span className="font-semibold text-r7-blue dark:text-r7-neon">"Start Calling"</span> to begin your session.
          ...
          <div className="glass-card">
            ...
            <div className="space-y-4">
              <div>
                <h3 className="text-lg font-semibold text-gray-800 dark:text-gray-200 mb-2">Step 1: Select Call Outcome</h3>
              ...
              <div>
                <h3 className="text-lg font-semibold text-gray-800 dark:text-gray-200 mb-2">Step 2: Choose an OK Code</h3>
              ...
              <div>
                <h3 className="text-lg font-semibold text-gray-800 dark:text-gray-200 mb-2">Step 3: Add Notes</h3>
                <p className="text-gray-700 dark:text-gray-300">
              ...
              <div>
                <h3 className="text-lg font-semibold text-gray-800 dark:text-gray-200 mb-2">Step 4: Save & Next</h3>
                <p className="text-gray-700 dark:text-gray-300">
                  Click <span className="font-semibold text-r7-blue dark:text-r7-neon">"Save & Next"</span> to log this call
          ...
          <div className="glass-card">
            ...
            <div className="space-y-3">
              <div>
                <h3 className="text-lg font-semibold text-gray-800 dark:text-gray-200">Contact Rate</h3>
                <p className="text-gray-700 dark:text-gray-300">
              ...
              <div>
                <h3 className="text-lg font-semibold text-gray-800 dark:text-gray-200">Meeting Rate</h3>
                <p className="text-gray-700 dark:text-gray-300">
              ...
              <div>
                <h3 className="text-lg font-semibold text-gray-800 dark:text-gray-200">Call Duration</h3>
                <p className="text-gray-700 dark:text-gray-300">
              ...
              <div>
                <h3 className="text-lg font-semibold text-gray-800 dark:text-gray-200">OK Code Distribution</h3>
                <p className="text-gray-700 dark:text-gray-300">
          ...
          <div className="glass-card border-2 border-glass bg-r7-blue/10 dark:bg-r7-neon/10">
            ...
            <ul className="space-y-3 text-gray-800 dark:text-gray-200">
              <li className="flex items-start">
                <span className="text-r7-blue dark:text-r7-neon mr-2">✓</span>
                <div>
